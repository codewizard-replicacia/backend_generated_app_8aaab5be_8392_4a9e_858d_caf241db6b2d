...
class ControllerTest {
  ...
  void  testCreateFrontendAppMetaTagsInstance() throws IOException {
    given()
        ...
        .when()
        .post("/generated_app/FrontendAppMetaTags")
        .then()
        .statusCode(HttpStatusCode.CREATED.getStatusCode());
  ...
  given()
   ...
   given()
            .when()
            .get("/generated_app/FrontendAppMetaTags?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body("value.get(0).Id", equalTo("<<replace_with_keyFieldValue>>"))
            .body("value.size()", is(1));
    given()
            .when()
            .get("/generated_app/FrontendAppMetaTags/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  @Test
  void  testCreateFETechnologyFeTechnologyFeaturesInstance() throws IOException {
    given()
        .contentType("application/json")
        .body(getPayload("FETechnologyFeTechnologyFeaturesInstance.json"))
        .when()
        .post("/generated_app/FETechnologyFeTechnologyFeatures")
        .then()
        .statusCode(HttpStatusCode.CREATED.getStatusCode());
   ...
   @Test
  public void testSystemFilterOptionsFETechnologyFeTechnologyFeatures() throws IOException {
  ...
  given()
   ...
   given()
            .when()
            .get("/generated_app/FETechnologyFeTechnologyFeatures?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body("value.get(0).Id", equalTo("<<replace_with_keyFieldValue>>"))
            .body("value.size()", is(1));
    given()
            .when()
            .get("/generated_app/FETechnologyFeTechnologyFeatures/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  @Test
  void  testCreateBETechnologyBeTechnologyFeaturesInstance() throws IOException {
    given()
        .contentType("application/json")
        .body(getPayload("BETechnologyBeTechnologyFeaturesInstance.json"))
        .when()
        .post("/generated_app/BETechnologyBeTechnologyFeatures")
        .then()
        .statusCode(HttpStatusCode.CREATED.getStatusCode());
   ...
   @Test
  public void testSystemFilterOptionsBETechnologyBeTechnologyFeatures() throws IOException {
  ...
  given()
   ...
   given()
            .when()
            .get("/generated_app/BETechnologyBeTechnologyFeatures?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body("value.get(0).Id", equalTo("<<replace_with_keyFieldValue>>"))
            .body("value.size()", is(1));
    given()
            .when()
            .get("/generated_app/BETechnologyBeTechnologyFeatures/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
