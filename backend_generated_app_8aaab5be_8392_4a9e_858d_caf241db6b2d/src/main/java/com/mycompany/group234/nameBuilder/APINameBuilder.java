...
public class APINameBuilder implements JPAEdmNameBuilder {
	...
	public String buildEntitySetName(final String entityTypeName) {
    	...
    	eSetName = "FETechnologyFeTechnologyFeatures".equals(entityTypeName) ? "FETechnologyFeTechnologyFeatures" : defaultNameBuilder.buildEntitySetName(entityTypeName);
    	...
    	eSetName = "BETechnologyBeTechnologyFeatures".equals(entityTypeName) ? "BETechnologyBeTechnologyFeatures" : defaultNameBuilder.buildEntitySetName(entityTypeName);
