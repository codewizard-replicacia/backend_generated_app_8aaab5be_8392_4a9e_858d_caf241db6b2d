...
@Entity(name = "BackendTemplateSupported_Capabilities")
@Table(schema = "\"generated_app\"", name = "\"BackendTemplateSupported_Capabilities\"")
@Data
public class BackendTemplateSupported_Capabilities{
