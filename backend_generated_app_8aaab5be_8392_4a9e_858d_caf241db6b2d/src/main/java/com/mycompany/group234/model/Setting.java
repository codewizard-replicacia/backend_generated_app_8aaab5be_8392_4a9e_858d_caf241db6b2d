...
@Entity(name = "Setting")
@Table(name = "\"Setting\"", schema =  "\"generated_app\"")
@Data
...
@JoinTable(
            name="\"SettingGitHubAccounts\"",
            joinColumns = @JoinColumn( name="\"GitHubCredId\""),
            inverseJoinColumns = @JoinColumn( name="\"GitHubAccounts\""), schema = "\"generated_app\"")
